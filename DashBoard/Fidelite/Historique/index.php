...
<input class="Terminer" type="submit" name="Supprimer" value="Supprimer la dernière transaction" onclick="return(confirm('Êtes vous sur de vouloir supprimer la dernière transaction ?'));"/>
</form>
<?php } 
else { ?>
<form name="FormBack" action="" method="POST">
<input class="Terminer" type="submit" name="Supprimer2" value="Supprimer la dernière transaction du client" onclick="return(confirm('Êtes vous sur de vouloir supprimer la dernière transaction ?'));"/>
</form>
<?php } ?>
...
while($HistoriqueClient=$RecupHistoriqueClient->fetch(PDO::FETCH_OBJ)) { ?>
    <tr>
        ...
        <td class="TableRose">
            ...
            <a href="<?php echo $Home; ?>/DashBoard/Fidelite/Historique/Apercu/?id=<?php echo $HistoriqueClient->id; ?>" target="_blank"><acronym title="Aperçu"><img src="<?php echo $Home; ?>/lib/img/Button/apercçu-rose.png"/></acronym></a>
            ...
            <a href="<?php echo $Home; ?>/DashBoard/Fidelite/Historique/activer.php?id=<?php echo $HistoriqueClient->id; ?>&retour=<?php echo $Id; ?>"><acronym title="Activé le bon"><img src="<?php echo $Home; ?>/lib/img/Button/désactiver-rose.png"/></acronym></a>
            <?php } elseif ($HistoriqueClient->fidelite==0) { ?>
            
            <?php } else { ?>
            <a href="<?php echo $Home; ?>/DashBoard/Fidelite/Historique/desactiver.php?id=<?php echo $HistoriqueClient->id; ?>&retour=<?php echo $Id; ?>"><acronym title="Désactivé le bon"><img src="<?php echo $Home; ?>/lib/img/Button/Activer-rose.png"/></acronym></a>
            <?php } ?>
        </td>
    </tr>
<?php
