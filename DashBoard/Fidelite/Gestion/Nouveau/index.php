...
if ((isset($_POST['Valider']))||(isset($_POST['Valider2']))) {
    ...
    elseif (strlen($Ville)<=2) {
        ...
        if (isset($_POST['Valider2'])) {
            ...
            header("location:".$Home."/DashBoard/?valid=".urlencode($Valid));
        }
        else {
...
<H1>Carte de fidélité</H2>
<label class="col_1_log">Carte N°:<font color='#FF0000'>*</font> :</label>
<input type="text" name="carte" required="required" autofocus value="<?php echo $CodeBar13; ?>"/>
<BR /><BR />

<H2 class="login">Informations</H2>
<label class="col_1_log">Civilité<font color='#FF0000'>*</font></label>
...
<br /><BR />
<label class="col_1_log">Nom<font color='#FF0000'>*</font> :</label>
<input  type="text" name="nom" value="<?php echo $_SESSION['nom']; ?>" required="required"/>
<br /><BR />
<label class="col_1_log">Prénom<font color='#FF0000'>*</font> :</label>
<inputtype="text" name="prenom" value="<?php echo $_SESSION['prenom']; ?>" required="required"/>
<BR /><BR />

<H2>Adresse</H2>
<label class="col_1_log">Adresse<font color='#FF0000'>*</font> :</label>
<textarea  name="adresse" required="required"><?php echo $_SESSION['adresse']; ?></textarea>
<br /><BR />
<label class="col_1_log">Code postal<font color='#FF0000'>*</font> :</label>
<input  type="text" name="cp" value="<?php echo $_SESSION['cp']; ?>" required="required"/>
<br /><BR />
<label class="col_1_log">Ville<font color='#FF0000'>*</font> :</label>
<input  type="text" name="ville" value="<?php echo $_SESSION['ville']; ?>" required="required"/>
<BR /><BR />

<H2>Contact</H1>
<label class="col_1_log">Téléphone :</label>
<input  type="text" value="<?php echo $_SESSION['tel']; ?>" name="tel"/>
<br /><BR />
<label class="col_1_log">E-mail<font color='#FF0000'>*</font> :</label>
