...
if ((isset($_POST['Envoyer']))&&($_POST['Envoyer']=="Envoyer")) {
  ...
  if (!isset($Erreur)) { 
    ...
    $Entete = "From: ".$Societe."<postmaster@kgs-express.fr>\r\n";
    ...
    www.neuro-soft.fr</p>
    <font color='#FF0000'>Cet e-mail contient des informations confidentielles et / ou protégées par la loi. Si vous n'en àªtes pas le véritable destinataire ou si vous l'avez reà§u par erreur, informez-en immédiatement son expéditeur et détruisez ce message. La copie et le transfert de cet e-mail sont strictement interdits.</font>                 
    </body></html>";

    if (mail($Destinataire, "Demande de contact", $Message_mail, $Entete)===false) {
       $Erreur = urlencode("L'e-mail n'a pu àªtre envoyé, vérifiez que vous l'avez entré correctement !");
